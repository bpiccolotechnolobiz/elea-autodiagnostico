...
public class BusquedaController {
	...
	public Autodiagnostico buscarAutodiagnostico(@RequestParam String nroLegajo, @RequestParam String dni) throws Exception {
		return busquedaService.buscarAutodiagnostico(nroLegajo, dni);
	}
